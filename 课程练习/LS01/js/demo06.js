...
var a1 = 2;
var a2 = "2";
console.log(a1==a2);//true or false 原理是什么？？？？？   ——true。==判断的是值
console.log(a1===a2);//false，===判断的是值和类型

var b1 = {};
var b2 = {};
console.log(b1==b2);//true or false 原理是什么？？？？？   ——false
console.log(b1===b2);//true or false          ——false  深拷贝，b1和b2指向的内容都是一个对象（赋值），但是地址（赋引用）不同
console.log(b1===b1);//true or false          ——true

//进一步理解
var c1 = 23;
var c2 = new Number(23);//装箱
...
console.log({}instanceof Object);//true   数组和函数都是对象
