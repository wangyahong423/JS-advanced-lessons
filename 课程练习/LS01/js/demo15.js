...
console.log(pushReturn);//push后数组的长度,3（push可以改变原来数组）
console.log(arr4);//['m','n','o']

var popReturn =arr4.pop();
console.log(popReturn);//pop出的元素,"o"。（pop可以改变原来数组）
console.log(arr4);//["m","n"]

////////////////////////////////
var arr5 = [1,2,3,4];
var shiftReturn = arr5.shift();
console.log(shiftReturn);//shift移除的元素，1。（shift可以改变原数组）
console.log(arr5);//[2,3,4]

var unshiftReturn = arr5.unshift(0);//在数组零号位置添加了0元素
...
console.error("error message");//报错
console.warn("warn message");//警告warn message
